...
const KB_FAQ = [
  ...
  },
  {
    ...
    answer: 'Khám tại bệnh viện được Đại sứ quán chỉ định. Hà Nội: Bệnh viện Phổi Trung ương, Bệnh viện Hồng Ngọc, Phòng khám Medlatec (một số cơ sở). TP.HCM: Bệnh viện Chợ Rẫy, Bệnh viện Phạm Ngọc Thạch, Trung tâm Y khoa Phước An (HEPA). ⚠️ DANH SÁCH THAY ĐỔI THƯỜNG XUYÊN. Bắt buộc kiểm tra mục "Thông báo" trên website KVAC trước khi đi khám. Giấy có giá trị 3 tháng. Khám sai bệnh viện sẽ không được chấp nhận!'
  },
  {
    id: 'faq-11',
    category: 'schools',
