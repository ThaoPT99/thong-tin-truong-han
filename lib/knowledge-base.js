...
• Từ 11/09/2026: SẼ được thay thế bằng tem Apostille (một bước duy nhất tại Bộ Ngoại giao)
...
const KB_FAQ = [
  ...
  },
  {
    ...
    answer: 'Có. Giấy tờ tiếng Việt cần: (1) Dịch sang tiếng Hàn hoặc Anh; (2) Công chứng bản dịch tại Phòng Công chứng; (3) Chứng nhận tại Bộ Ngoại giao (MOFA) hoặc Sở Ngoại vụ; (4) Hợp pháp hóa tại ĐSQ Hàn Quốc. Lưu ý: Từ 11/09/2026, Việt Nam chính thức áp dụng Công ước Apostille — quy trình hợp pháp hóa sẽ được thay thế bằng tem Apostille (một bước duy nhất tại Bộ Ngoại giao, không cần mang sang ĐSQ Hàn).'
  },
  {
    id: 'faq-6',
    category: 'study-plan',
