...
• Cho phép làm thêm sau 6 tháng (cần xin phép, tối đa 10-25h/tuần tuỳ TOPIK)
• Yêu cầu: chứng minh tài chính $10,000+
• Không yêu cầu TOPIK đầu vào (nhưng có là lợi thế)
• Có thể chuyển lên visa D-2 sau khi đạt TOPIK 3+

Quy trình xin visa:
1. Nhận admission letter từ trường Hàn Quốc
2. Chuẩn bị đầy đủ hồ sơ theo checklist
3. Đến KVAC trực tiếp lấy số thứ tự (đã dừng đặt lịch online từ 06/04/2026)
4. Nộp hồ sơ tại KVAC + đóng lệ phí
5. Chờ kết quả 16 ngày trở lên
...
Đặc điểm chính:
• Thời hạn: thường cấp 1-2 năm/lần, gia hạn theo chương trình học (tối đa 2 năm/lần)
• Cho phép làm thêm sau 6 tháng (cần xin phép, tối đa 10-30h/tuần tuỳ bậc học và TOPIK)
• Yêu cầu: TOPIK 3+ hoặc IELTS 5.5+, tài chính $10,000-$20,000 (tuỳ trường)
• Thư giới thiệu: không bắt buộc từ ĐSQ (một số trường có yêu cầu riêng)
...
Khác biệt với D-4-1: D-2 yêu cầu cao hơn về tài chính, học lực và tiếng Hàn, nhưng cho phép ở lại làm việc (E7) sau tốt nghiệp.`
  },
  {
    ...
    content: `Sau khi hoàn thành khóa học tiếng Hàn với visa D-4-1, bạn có thể chuyển lên visa D-2 để học đại học chính quy ngay tại Hàn Quốc mà không cần về nước.

Điều kiện chuyển đổi:
1. Đạt TOPIK 3+ (yêu cầu phổ biến, một số trường yêu cầu TOPIK 4)
2. Xin admission letter từ trường đại học
3. Chứng minh tài chính: ~20,000,000-25,000,000 KRW (~$18,000-20,000) trong tài khoản ngân hàng Hàn Quốc, duy trì ít nhất 28 ngày
4. Điểm chuyên cần khóa tiếng trên 70-90%
5. Nộp đơn xin chuyển đổi tại Immigration Hàn Quốc

Quy trình:
1. Nhận giấy báo nhập học (Standard Admission Letter) từ trường ĐH
2. Chuẩn bị hồ sơ: bảng điểm, chứng nhận hoàn thành khóa tiếng, hộ chiếu, ARC
3. Nộp hồ sơ tại Văn phòng Xuất nhập cảnh (hoặc qua trường)
4. Đóng phí chuyển đổi visa (~100,000-135,000 KRW)
5. Chờ kết quả 2-4 tuần

Giấy tờ cần chuẩn bị:
• Hộ chiếu + Thẻ ngoại kiều (ARC)
• Giấy chứng nhận hoàn thành khóa tiếng + bảng điểm
• Admission Letter từ trường ĐH
• Đơn xin chuyển đổi visa (mẫu tích hợp)
• Xác nhận số dư tài khoản ngân hàng (cấp trong 30 ngày gần nhất)
• Chứng chỉ TOPIK (hoặc chứng chỉ ngoại ngữ khác)
• Bảng điểm + bằng tốt nghiệp cao nhất
• Ảnh thẻ 3.5x4.5cm nền trắng

Lưu ý: Nên nộp trước khi visa D-4-1 hết hạn ít nhất 1 tháng. Có thể nộp qua văn phòng quốc tế của trường để được hỗ trợ.`
  },
  {
    id: 'visa-rejection',
    category: 'visa',
...
Lưu ý quan trọng: Từ 13/04/2025, ĐƠN XIN VISA CHỈ ĐƯỢC ĐIỀN BẰNG TIẾNG HÀN HOẶC TIẾNG ANH. Điền bằng tiếng Việt sẽ không được chấp nhận và phải điền lại.
...
• Mang đến Sở Ngoại vụ (Hà Nội/TP.HCM) hoặc Cục Lãnh sự
...
• Từ 11/09/2026: SẼ được thay thế bằng tem Apostille — xin tại Cục Lãnh sự (Hà Nội) hoặc Sở Ngoại vụ (TP.HCM). Hàn Quốc là thành viên Công ước Apostille nên KHÔNG cần mang giấy tờ qua ĐSQ/LSQ Hàn Quốc nữa.
...
• D-2: Tối thiểu $10,000-$20,000 (~250-500 triệu VND, tuỳ trường/khu vực)
• Mở tại quầy giao dịch (KHÔNG chấp nhận sổ online)
• Gửi kỳ hạn 6-12 tháng (6 tháng là chấp nhận được, 12 tháng là lý tưởng)
...
Trả lời càng chi tiết, Study Plan càng thuyết phục! Sử dụng AI hỗ trợ trong tab "📋 Hồ sơ của tôi" để được giúp đỡ.`
  ...
  // ─── Process Category ───
  {
    ...
    content: `Quy trình xử lý hồ sơ du học Hàn Quốc gồm 5 bước (cập nhật 2026):
...
BƯỚC 4: NỘP HỒ SƠ & CHỜ KẾT QUẢ (3-5 tuần)
• Đến KVAC trực tiếp lấy số (đã dừng đặt lịch online)
• Nộp hồ sơ tại KVAC + đóng lệ phí
• Theo dõi kết quả (từ 16 ngày làm việc trở lên)
...
📍 Địa chỉ KVAC:
• Hà Nội: Tầng 12, Discovery Complex, 302 Cầu Giấy, phường Cầu Giấy
• TP.HCM: 253 Điện Biên Phủ, Phường Xuân Hòa, Quận 3

🕐 Giờ làm việc:
• Hà Nội: Thứ 2-6, 08:00-16:30 (đã thay đổi từ 01/04/2026)
• TP.HCM: Thứ 2-6, 08:30-17:00 (nghỉ trưa 12:00-13:00)
• Nghỉ Thứ 7, CN và ngày lễ

📋 Quy trình nộp hồ sơ (cập nhật 04/2026):
1. Chuẩn bị đầy đủ hồ sơ gốc + bản dịch
2. Đến KVAC trực tiếp lấy số thứ tự (đã dừng đặt lịch online từ 06/04/2026)
3. Nộp hồ sơ tại quầy + đóng lệ phí (chỉ nhận tiền mặt)
4. Nhận biên nhận + theo dõi kết quả online

💰 Lệ phí:
• Phí xét duyệt visa (visa >90 ngày): $60 (đóng bằng tiền mặt)
• Phí dịch vụ KVAC: 390,000 VND/bộ
• Phí gửi trả kết quả: 60,000 VND (nội thành) / 80,000 VND (ngoại thành)
• Phí phòng chờ cao cấp (tuỳ chọn): 390,000 VND/bộ

⏱ Thời gian xử lý: Visa cá nhân từ 16 ngày làm việc trở lên (không tính T7, CN, lễ)

📝 Lưu ý đơn xin visa: Từ 13/04/2025, CHỈ điền bằng tiếng Hàn hoặc tiếng Anh (không chấp nhận tiếng Việt)

🔗 Website chính thức:
• KVAC Hà Nội: https://visaforkorea-vt.com/ — Email: kvac@visaforkorea-vt.com
• KVAC TP.HCM: https://www.visaforkorea-hc.com/ — Email: kvac.hcm@visaforkorea-hc.com

⚠️ Lưu ý quan trọng: Danh sách bệnh viện khám lao phổi thay đổi thường xuyên. Kiểm tra mục "Thông báo" trên website KVAC trước khi đi khám.`
  },
...
const KB_FAQ = [
  {
    ...
    answer: 'D-4-1 là visa học tiếng Hàn, thời hạn 6 tháng - 2 năm, yêu cầu tài chính $10,000+, không yêu cầu TOPIK đầu vào. D-2 là visa đại học chính quy, thời hạn 1-2 năm/lần (gia hạn theo chương trình), yêu cầu: tài chính $10,000-$20,000 (tuỳ trường), TOPIK 3+ hoặc IELTS 5.5+. Thư giới thiệu: không bắt buộc từ ĐSQ (tuỳ trường). D-2 cho phép chuyển đổi sang visa E7 sau tốt nghiệp.'
  },
  {
    id: 'faq-2',
    category: 'finance',
    question: 'Cần bao nhiêu tiền trong sổ tiết kiệm?',
    answer: 'D-4-1: tối thiểu $10,000 (~250 triệu VND). D-2: $10,000-$20,000 (tuỳ trường/khu vực). Sổ phải mở tại quầy giao dịch (không chấp nhận sổ online), gửi kỳ hạn 12 tháng, mở trước 3-6 tháng. Kèm giấy xác nhận số dư cấp trong vòng 30 ngày.'
  },
  {
    id: 'faq-3',
    category: 'process',
    question: 'Mất bao lâu để xử lý visa?',
    answer: 'Thời gian xử lý visa cá nhân Hàn Quốc là từ 16 ngày làm việc trở lên (không tính T7, CN, lễ). Qua công ty du lịch chỉ định: 6-9 ngày. Nên nộp hồ sơ trước ngày nhập học ít nhất 6-8 tuần. Mùa cao điểm (tháng 2-3 và 8-9) có thể kéo dài hơn.'
  },
  {
    id: 'faq-4',
    category: 'process',
    question: 'Nộp hồ sơ ở đâu? Có cần đặt lịch không?',
    answer: 'Nộp hồ sơ tại KVAC (Korea Visa Application Center). Địa chỉ: Hà Nội — Tầng 12, Discovery Complex, 302 Cầu Giấy; TP.HCM — 253 Điện Biên Phủ, Phường Xuân Hòa, Q.3. Lưu ý: từ 06/04/2026, KVAC Hà Nội ĐÃ DỪNG đặt lịch hẹn online. Đến trực tiếp lấy số thứ tự. KVAC TP.HCM vẫn đặt lịch online qua website visaforkorea-hc.com.'
  },
  {
    id: 'faq-5',
    category: 'documents',
    question: 'Giấy tờ dịch thuật cần công chứng không?',
    answer: 'Có. Giấy tờ tiếng Việt cần: ● TRƯỚC 11/09/2026: (1) Dịch sang tiếng Hàn/Anh → (2) Công chứng bản dịch → (3) Chứng nhận tại Bộ Ngoại giao (MOFA) hoặc Sở Ngoại vụ → (4) Hợp pháp hóa tại ĐSQ Hàn Quốc (Hà Nội) hoặc LSQ (TP.HCM). ● TỪ 11/09/2026: Quy trình rút gọn — Sau khi công chứng, xin tem Apostille tại Cục Lãnh sự (Hà Nội, 44 Tràng Thi) hoặc Sở Ngoại vụ (TP.HCM, 6 Alexander De Rhodes). Do Hàn Quốc là thành viên Công ước Apostille, giấy tờ có tem Apostille được công nhận trực tiếp tại Hàn Quốc, KHÔNG cần qua ĐSQ/LSQ nữa. Tiết kiệm 5-10 ngày.'
  },
  {
    id: 'faq-6',
    category: 'study-plan',
  ...
  },
  {
    ...
    answer: 'Khám tại bệnh viện được Đại sứ quán chỉ định. Hà Nội: Bệnh viện Phổi Trung ương, Bệnh viện Hồng Ngọc, Phòng khám Medlatec (một số cơ sở). TP.HCM: Bệnh viện Chợ Rẫy, Bệnh viện Phạm Ngọc Thạch, Bệnh viện Thống Nhất, Trung tâm Y khoa Phước An (HEPA). ⚠️ DANH SÁCH THAY ĐỔI THƯỜNG XUYÊN. Bắt buộc kiểm tra mục "Thông báo" trên website KVAC trước khi đi khám. Giấy có giá trị 3 tháng. Khám sai bệnh viện sẽ không được chấp nhận!'
  },
  {
    id: 'faq-11',
    category: 'schools',
  ...
  },
  {
    ...
    answer: 'Không bắt buộc nhưng là điểm cộng lớn. K-Study (sổ đóng băng) mở tại Shinhan, Woori hoặc KEB Hana Bank (có chi nhánh tại Việt Nam). Số tiền: 8,000,000-10,000,000 KRW (~$6,000-$7,500), không phải USD. Số tiền này bị đóng băng, không rút được ngay. Ưu điểm: có thể mở trước khi nộp visa, được ĐSQ Hàn Quốc ưu tiên cao hơn sổ tiết kiệm thường. Một số trường bắt buộc loại sổ này cho visa D-4-1.'
  },
  {
    id: 'faq-13',
    category: 'process',
    question: 'Có thể vừa học vừa làm thêm không?',
    answer: 'Có, nhưng cần xin phép. Sau 6 tháng nhập cảnh, du học sinh có thể xin giấy phép làm thêm (Part-time Work Permit) từ Văn phòng Xuất nhập cảnh. Số giờ tuỳ TOPIK và bậc học: có TOPIK 2-3: tối đa 20-25h/tuần (D-4-1), 25h/tuần (D-2 ĐH), 30h/tuần (D-2 Cao học). Chưa có TOPIK: chỉ 10-15h/tuần. Cuối tuần và kỳ nghỉ lễ thường không giới hạn. Mức lương tối thiểu năm 2025: 10,030 KRW/giờ. Yêu cầu: chuyên cần >80%, GPA >= 2.0/4.5.'
  },
  {
    id: 'faq-14',
    category: 'study-plan',
  ...
  },
  {
    ...
    answer: 'Tỉ lệ đậu phụ thuộc vào chất lượng hồ sơ, không có con số cố định do ĐSQ Hàn Quốc không công bố thống kê chính thức. D-4-1 thường có tỉ lệ đậu cao hơn D-2 vì yêu cầu thấp hơn. Hồ sơ tốt (GPA 6+, tài chính vững, Study Plan rõ ràng, không có yếu tố rủi ro) sẽ có cơ hội đậu cao. Hồ sơ yếu (GPA thấp, gap year dài, tài chính không rõ ràng, có người thân bất hợp pháp) sẽ có nguy cơ trượt cao hơn.'
  },
  {
    id: 'faq-17',
    category: 'schools',
  ...
  },
  {
    ...
    answer: 'Nên bắt đầu trước kỳ nhập học 4-6 tháng. Lưu ý: thời gian xử lý visa hiện tại từ 16 ngày làm việc trở lên, nên nộp hồ sơ sớm hơn. Timeline gợi ý: Tháng 1-2: đánh giá hồ sơ, chọn trường. Tháng 3-4: mở sổ TK, chuẩn bị giấy tờ. Tháng 5: nộp hồ sơ visa. Tháng 6-7: nhận visa, chuẩn bị bay (kỳ tháng 9). Đối với kỳ tháng 3: dịch chuyển timeline sớm hơn 6 tháng.'
  },
];
