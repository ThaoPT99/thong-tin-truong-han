...
// ═══════════════════════════════════════════════════════════
// KB_ARTICLES — 36 bài viết chuyên sâu
// ═══════════════════════════════════════════════════════════

const KB_ARTICLES = [
  // ═══════════════════════════════════════════
  // VISA CATEGORY (8 articles)
  // ═══════════════════════════════════════════
...
| Giờ làm thêm | 20-25h/tuần tuỳ TOPIK (chưa đạt chuẩn: 10h) |
...
• Đóng lệ phí: $60 (visa dài hạn >90 ngày, theo lịch phí MOFA) + 390,000 VND (phí dịch vụ KVAC) — kiểm tra bảng lệ phí mới nhất trên website KVAC trước khi nộp
...
| Làm thêm | 20-25h/tuần | 25-30h/tuần |
...
• Phí: ~100,000 KRW (phí chuyển đổi tư cách lưu trú)
...
• Không đợi đến phút cuối — nếu quá hạn (overstay), bạn sẽ bị xử phạt hành chính theo khung thời gian quá hạn (không tính theo ngày), mức phạt có thể từ vài triệu KRW và bị cấm nhập cảnh Hàn Quốc
...
• Chứng nhận bảo hiểm
• Phí gia hạn: 60,000 KRW (phí gia hạn thời gian lưu trú chuẩn)
...
`
  },
  {
    id: 'visa-e7-m-k-core',
    category: 'visa',
    title: 'Visa E-7-M (K-CORE) — Lộ trình "vừa học vừa làm" miễn tài chính & định cư dài hạn',
    summary: 'Visa E-7-M (K-CORE) thí điểm 2026-2027 cho 16 trường cao đẳng kỹ thuật: TOPIK 3+ được miễn chứng minh tài chính, làm thêm 35h/tuần, tốt nghiệp xin E-7-M rồi chuyển F-2 định cư.',
    tags: ['E-7-M', 'K-CORE', 'visa', 'định cư', 'cao đẳng', 'việc làm', '2026'],
    content: `E-7-M (thường gọi là visa K-CORE) là chương trình thí điểm của Bộ Tư pháp Hàn Quốc dành cho sinh viên quốc tế theo học các chương trình kỹ thuật tại các trường cao đẳng (전문대학) được chỉ định. "M" nghĩa là middle-skill — bậc kỹ năng trung cấp giữa lao động chuyên môn và lao động phổ thông. Đây là lộ trình DUY NHẤT hiện nay cho phép sinh viên vừa học vừa làm với đãi ngộ đặc biệt, mở đường định cư dài hạn tại Hàn Quốc.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
NHỮNG ĐIỂM ĐẶC BIỆT CỦA E-7-M
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

| Đặc quyền | Chi tiết |
|-----------|----------|
| Thời gian thí điểm | 01/2026 - 31/12/2027 |
| Phạm vi áp dụng | 16 trường cao đẳng được chỉ định (1 ngành kỹ thuật/trường) |
| Miễn tài chính | TOPIK 3+ → KHÔNG cần chứng minh tài chính (thường 16-20 triệu KRW) |
| Làm thêm | Tối đa 35h/tuần trong học kỳ (trần chuẩn SV cao đẳng là 30h) |
| Sau tốt nghiệp | Xin visa E-7-M làm việc chuyên môn tại Hàn |
| Lộ trình định cư | E-7-M → F-2 (cư trú dài hạn) |

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
16 TRƯỜNG THÍ ĐIỂM GỒM NHỮNG AI?
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Bộ Tư pháp chỉ định đúng 16 trường cao đẳng (전문대학), mỗi trường 1 chương trình đào tạo hướng kỹ thuật, tập trung vào lĩnh vực sản xuất - công nghiệp:

• **Các ngành tiêu biểu**: Ô tô, xe điện (EV), CAD/CAM thông minh, cơ khí, dệt may kỹ thuật...
• **Khu vực tập trung**: Gyeonggi, Busan, Daegu, Bắc Jeolla và các tỉnh/thành khác trên toàn quốc
• **Mục tiêu**: Gắn kết sinh viên với nhu cầu nhân lực kỹ thuật của địa phương, giảm phụ thuộc lao động nước ngoài

📌 **MẸO**: Danh sách 16 trường + ngành được duyệt thay đổi theo từng kỳ tuyển sinh. Hãy xác nhận trường của bạn có chương trình E-7-M ngay khi nhận admission letter — KHÔNG phải mọi chương trình cao đẳng đều thuộc diện này.
...
| Điều kiện | Yêu cầu |
|-----------|---------|
| Trúng tuyển | Vào 1 trong 16 chương trình được chỉ định |
| Tiếng Hàn | TOPIK 3 trở lên (chìa khóa để được miễn tài chính) |
| Chứng minh tài chính | MIỄN khi đạt TOPIK 3+ (đây là điểm hấp dẫn nhất) |
| Loại visa | D-2 (sinh viên chính quy) khi xin nhập học |

⚠️ **LƯU Ý**: Quyền miễn chứng minh tài chính chỉ áp dụng khi bạn có TOPIK 3+ tại thời điểm xin visa. Chưa đạt TOPIK 3 → vẫn phải chứng minh tài chính như bình thường (~16-20 triệu KRW tùy khu vực).

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
LÀM THÊM 35 GIỜ/TUẦN
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Sinh viên trong chương trình được làm thêm tối đa **35 giờ/tuần** trong học kỳ — cao hơn trần 30h của sinh viên cao đẳng thường và cao hơn hẳn 10h của du học sinh tiếng D-4-1. Với mức lương tối thiểu 2026 là 10,320 KRW/giờ, làm đủ 35h/tuần có thể mang lại khoảng **1,200,000-1,500,000 KRW/tháng (~25-32 triệu VND)** — đủ trang trải phần lớn chi phí sinh hoạt và một phần học phí.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
LỘ TRÌNH ĐỊNH CƯ: E-7-M → F-2
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

**Bước 1: Tốt nghiệp đúng chương trình chỉ định** (2-3 năm)

**Bước 2: Xin visa E-7-M (làm việc chuyên môn)** — cần đủ 2 điều kiện:
• Có hợp đồng lao động đúng chuyên ngành với mức lương khởi điểm tối thiểu ~26 triệu KRW/năm
• Đạt chuẩn tiếng Hàn: TOPIK 5 HOẶC hoàn thành KIIP (Chương trình hội nhập xã hội) cấp 4

**Bước 3: Làm việc tích lũy để chuyển F-2 (cư trú dài hạn):**
• **5 năm** làm việc liên tục theo diện E-7-M
• HOẶC **3 năm** nếu làm cùng một công ty tại khu vực được chính phủ chỉ định là vùng suy giảm dân số (인구감소지역)

📊 **THỐNG KÊ**: Toàn bộ lộ trình từ nhập học đến khi đủ điều kiện F-2 mất khoảng 5-8 năm — đây là một trong những con đường ngắn và rõ ràng nhất để sinh viên quốc tế định cư lâu dài tại Hàn Quốc hiện nay.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
AI NÊN CÂN NHẮC E-7-M?
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

✅ **Phù hợp:**
• Học sinh hướng đến ngành kỹ thuật/công nghiệp (không bắt buộc học thuật cao)
• Muốn ở lại Hàn Quốc làm việc lâu dài và định cư
• Tài chính hạn chế nhưng có khả năng đạt TOPIK 3 sớm

❌ **KHÔNG phù hợp:**
• Muốn học ngành phi kỹ thuật (kinh tế, xã hội, nghệ thuật...)
• Chỉ đi du học để lấy bằng rồi về nước
• Chưa sẵn sàng cam kết làm việc tại Hàn nhiều năm sau tốt nghiệp

🚫 **SAI LẦM THƯỜNG GẶP**:
• Nghĩ rằng mọi trường cao đẳng đều có chương trình E-7-M — thực tế chỉ 16 trường được chỉ định
• Nghĩ miễn tài chính là "miễn phí học phí" — bạn chỉ được MIỄN CHỨNG MINH TÀI CHÍNH, học phí vẫn phải đóng
• Bỏ qua yêu cầu TOPIK 5/KIIP cấp 4 khi xin E-7-M sau tốt nghiệp — chuẩn bị tiếng Hàn ngay từ năm đầu

⚠️ **LƯU Ý**: Chương trình đang trong giai đoạn THÍ ĐIỂM đến hết 2027. Các điều kiện chi tiết (danh sách trường, mức lương tối thiểu, ngưỡng TOPIK) có thể được điều chỉnh. Luôn kiểm tra thông báo mới nhất của Bộ Tư pháp Hàn Quốc và trường của bạn trước khi quyết định.
`
  },
...
• Dịch bởi công ty dịch thuật hoặc cá nhân người dịch (Phòng Công chứng KHÔNG dịch — chỉ chứng thực chữ ký người dịch ở Bước 2)
...
|---------|---------|-----------|
| Cục Lãnh sự Hà Nội | 40 Trần Phú, Ba Đình | 1-3 ngày |
| Sở Ngoại vụ TP.HCM | 6 Alexandre de Rhodes, Bến Nghé, Q.1 | 1-3 ngày |

⚠️ **LƯU Ý**: Giấy tờ công chứng tại **Văn phòng Công chứng tư nhân** cần xác nhận con dấu tại **Sở Tư pháp** trước khi nộp lên Cục Lãnh sự/Sở Ngoại vụ (giấy tờ từ Phòng Công chứng Nhà nước thường không cần bước này). Kiểm tra với nơi công chứng trước khi đi.
...
• **TỪ 11/09/2026**: KHÔNG cần qua ĐSQ/LSQ nữa! Chỉ cần xin **tem Apostille** tại Cục Lãnh sự (Hà Nội) hoặc Sở Ngoại vụ (TP.HCM). Hàn Quốc là thành viên Công ước Apostille nên giấy tờ có tem Apostille được công nhận trực tiếp tại Hàn Quốc. Lệ phí chứng nhận lãnh sự/hợp pháp hóa lãnh sự và chứng nhận Apostille đều **30,000đ/giấy tờ** (Thông tư 157/2016/TT-BTC; Nghị định 293/2026/NĐ-CP). Bạn tiết kiệm thời gian (không còn bước qua ĐSQ/LSQ) và không mất lệ phí hợp pháp hóa tại ĐSQ Hàn Quốc (thường tính theo USD/giấy tờ).

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
LƯU Ý QUAN TRỌNG
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

• Bản dịch công chứng và giấy chứng nhận lãnh sự/Apostille **không có thời hạn theo luật**, nhưng KVAC/ĐSQ thường yêu cầu giấy tờ cấp gần ngày nộp. Riêng một số giấy tờ có thời hạn cụ thể: **giấy khám lao phổi (3 tháng), xác nhận số dư ngân hàng (30 ngày), thư nhập học (tuỳ trường)**. Tính toán thời gian hợp lý!
...
• Phí: 30,000 KRW (lệ phí đăng ký người nước ngoài chuẩn)
...
| Hà Nội | Bệnh viện Đa khoa Hồng Ngọc | Dịch vụ tốt |
| Hà Nội | Hà Nội Family Medical Practice | Được chỉ định |
| Hà Nội | Bệnh viện Đa khoa Tràng An | Được chỉ định |
| TP.HCM | Trung tâm Y khoa Phước An (HEPA) | Dịch vụ cao cấp |
| TP.HCM | Bệnh viện ĐH Y Dược TP.HCM | Được chỉ định |
| TP.HCM | Bệnh viện Ngoại khoa Sante | Được chỉ định |
| TP.HCM | Bệnh viện Đa khoa Quốc tế Sài Gòn | Được chỉ định |
...
• Các bệnh viện chỉ định (form ĐSQ): ~300,000 - 400,000 VND (VD: BV Phổi TW ~305,000đ, Hồng Ngọc ~305,000đ, Phước An 300,000đ)
• Gói khám sức khỏe tổng quát (xét nghiệm thêm): 500,000 - 1,200,000 VND
• Dịch vụ lấy kết quả nhanh trong ngày: có thể cao hơn, kiểm tra trực tiếp từng bệnh viện
...
💡 **KINH NGHIỆM THỰC TẾ**: Hồ sơ có sổ tiết kiệm mở trước 6 tháng thường được đánh giá cao hơn so với hồ sơ mở trước 1-2 tháng (kinh nghiệm từ các trung tâm tư vấn — không có thống kê chính thức nào được công bố).
...
*Theo lịch phí MOFA chính thức (đơn nhập cảnh dài hạn >90 ngày). Kiểm tra bảng lệ phí mới nhất trên website KVAC trước khi nộp — lệ phí có thể thay đổi.
...
`
  },
  {
    ...
    content: `Tham gia bảo hiểm y tế là BẮT BUỘC đối với du học sinh tại Hàn Quốc. Từ tháng 3/2021, tất cả du học sinh quốc tế phải tham gia bảo hiểm y tế quốc gia Hàn Quốc (National Health Insurance).
...
| Loại | Tuổi | GPA | TOPIK |
|------|------|-----|-------|
| GKS-U (Đại học) | Dưới 25 | ≥80% (hoặc top 20% lớp) | Không bắt buộc (lợi thế lớn) |
| GKS-G (Sau ĐH) | Dưới 40 | ≥80% (hoặc top 20% lớp) | Ưu tiên TOPIK 4+ |
...
| Extension of Stay | Gia hạn visa | 1-3 tuần | 60,000 KRW |
| Change of Status | Chuyển đổi visa | 2-4 tuần | 100,000 KRW |
...
*Chuẩn TOPIK để được cấp phép: D-4-1 cần TOPIK 2 (sau 6 tháng), D-2 ĐH cần TOPIK 3, D-2 Cao học cần TOPIK 4 (hoặc KIIP tương đương). "Trường đạt chuẩn" (인증대학) do Bộ Tư pháp công nhận được cộng thêm 5h. Cuối tuần & kỳ nghỉ: D-2 không giới hạn giờ, D-4-1 vẫn giới hạn.
...
const KB_FAQ = [
  ...
  },
  {
    ...
    answer: 'Visa du học D-4-1/D-2: 13-20 ngày làm việc (không tính T7, CN, lễ). Nên nộp hồ sơ trước ngày nhập học ít nhất 6-8 tuần. Mùa cao điểm (tháng 2-3 và 8-9) có thể kéo dài hơn. Lời khuyên: nộp càng sớm càng tốt trong khung thời gian cho phép.'
  },
  {
    id: 'faq-4',
    category: 'process',
  ...
  },
  {
    ...
    answer: 'CÓ. TRƯỚC 11/09/2026: (1) Dịch sang Hàn/Anh → (2) Công chứng bản dịch → (3) Chứng nhận tại MOFA/Sở Ngoại vụ → (4) Hợp pháp hóa tại ĐSQ Hàn Quốc (Hà Nội) hoặc LSQ (TP.HCM). TỪ 11/09/2026: Quy trình rút gọn — Sau khi công chứng, xin tem Apostille tại Cục Lãnh sự (Hà Nội, 40 Trần Phú) hoặc Sở Ngoại vụ (TP.HCM, 6 Alexandre de Rhodes). KHÔNG cần qua ĐSQ/LSQ nữa! Lệ phí chứng nhận lãnh sự/hợp pháp hóa lãnh sự và Apostille đều 30,000đ/giấy tờ (Thông tư 157/2016/TT-BTC; Nghị định 293/2026/NĐ-CP). Tiết kiệm thời gian và không mất lệ phí hợp pháp hóa tại ĐSQ/LSQ Hàn Quốc (tính theo USD/giấy tờ).'
  },
  {
    id: 'faq-6',
    category: 'study-plan',
  ...
  },
  {
    ...
    answer: 'Khám tại bệnh viện được Đại sứ quán chỉ định. Hà Nội: BV Phổi Trung ương, BV Hồng Ngọc, Hà Nội Family Medical Practice, BV Đa khoa Tràng An. TP.HCM: Trung tâm Y khoa Phước An (HEPA), BV ĐH Y Dược, BV Ngoại khoa Sante, BV Đa khoa Quốc tế Sài Gòn. ⚠️ DANH SÁCH THAY ĐỔI THƯỜNG XUYÊN — kiểm tra mục "Thông báo" trên website KVAC trước khi khám. Giấy có giá trị 3 tháng. Chi phí: ~300,000-400,000 VND (tại các bệnh viện chỉ định).'
  },
  {
    id: 'faq-11',
    category: 'schools',
  ...
  },
  {
    ...
    answer: 'CÓ. D-4-1 cần chờ sau 6 tháng nhập cảnh mới được làm thêm; D-2 có thể xin giấy phép làm thêm sau khi hoàn thành học kỳ đầu tiên (đạt yêu cầu GPA/TOPIK). Cần xin giấy phép làm thêm (Part-time Work Permit) từ Immigration. Số giờ (theo quy định Bộ Tư pháp): D-4-1 sau 6 tháng + TOPIK 2 → 20h/tuần (trường đạt chuẩn: 25h); D-2 ĐH cần TOPIK 3 → 20h/tuần (trường đạt chuẩn: 25h); D-2 Cao học cần TOPIK 4 → 30h/tuần. Chưa đạt chuẩn → 10h/tuần (D-4-1, D-2) hoặc 15h (cao học). Cuối tuần và kỳ nghỉ lễ: D-2 không giới hạn, D-4-1 vẫn giới hạn. Mức lương tối thiểu 2025: 10,030 KRW/giờ; 2026: 10,320 KRW/giờ. Yêu cầu: chuyên cần >90%, GPA >= 2.0/4.5.'
  },
  {
    id: 'faq-14',
    category: 'study-plan',
  ...
  },
  {
    ...
    answer: 'CÓ. Sau khi tốt nghiệp chương trình đại học (D-2), bạn có thể chuyển sang visa E7 (visa làm việc chuyên nghiệp, thường là E-7-1 cho chuyên gia). Điều kiện: (1) Đã tốt nghiệp, (2) Có hợp đồng lao động với công ty Hàn Quốc đúng ngành đã học, (3) Mức lương đáp ứng yêu cầu tối thiểu (E-7-1: khoảng 80% GNI, ~31 triệu KRW/năm; E-7-2/3: ~26 triệu KRW/năm), (4) Ngành học phù hợp với công việc. Một số ngành như IT, Kỹ thuật, Kinh doanh có cơ hội E7 cao hơn các ngành khác.'
  },
  {
    id: 'faq-28',
    category: 'documents',
...
**Chuyển đổi D4 → D2:**
  ...
  — Nộp tại Immigration Hàn Quốc (2-4 tuần), phí ~100,000 KRW
`;
