...
<body>
  ...
  <div id="zalo-popup" class="zalo-popup" role="dialog" aria-modal="true" aria-labelledby="zalo-popup-title">
    ...
    <div class="zalo-popup-card">
      ...
      <h2 id="zalo-popup-title" class="zalo-popup-title">Tự làm visa du học</h2>
      <p class="zalo-popup-subtitle">Tham gia nhóm Zalo để được hướng dẫn tự làm visa du học miễn phí</p>
      <div class="zalo-popup-qr-wrap">
        <img src="/zalo-qr-d2-6.png" alt="Mã QR tham gia nhóm Zalo" class="zalo-popup-qr">
      </div>
      <p class="zalo-popup-hint">Quét mã QR bằng Zalo để bắt đầu tự làm visa</p>
  ...
  <button type="button" class="zalo-fab" onclick="openZaloPopup()" title="Tự làm visa du học" aria-label="Mở popup tự làm visa du học">
