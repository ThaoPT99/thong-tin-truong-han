...
(function() {
  ...
  var SMART_CHECKLIST_ENHANCEMENTS = {
    ...
    'A1-7': { step: 7, cost: '~300,000đ', time: '1 ngày', tip: 'Khám tại bệnh viện ĐSQ chỉ định (HN: BV Phổi TW, Hồng Ngọc, Family, Tràng An...; HCM: Phước An HEPA, ĐH Y Dược, Sante, Quốc tế Sài Gòn...). Kiểm tra danh sách mới trên website KVAC.' },
    ...
    'A4-1': { step: 10, cost: '10,000+ USD', time: '1 ngày', tip: 'Mở tại quầy ngân hàng (không online). Kỳ hạn 12 tháng. Để sổ càng lâu càng tốt. D-2 yêu cầu cao hơn (10,000-20,000 USD tuỳ trường).' },
