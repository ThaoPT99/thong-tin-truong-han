        ...
        <div class="int-body">
          ...
          <div id="int-setup" class="int-setup">
            ...
            <div class="int-actions">
              <button type="button" class="btn btn-primary btn-lg" onclick="window.clStartInterview()">
                🎬 Bắt đầu phỏng vấn
              </button>
            </div>
          </div>
          ...
          <!-- Interview Chat -->
          <div id="int-chat" style="display:none">
            <div class="int-progress">
              <div class="int-progress-text">Câu hỏi: <span id="int-q-num">0</span>/<span id="int-q-total">0</span></div>
              <div class="int-progress-bar">
                <div id="int-progress-fill" class="int-progress-fill" style="width:0%"></div>
              </div>
              <div class="int-score-badge" id="int-score-badge"></div>
            </div>
            <div id="int-messages" class="int-messages"></div>
            <div id="int-input-area" class="int-input-area">
              <div id="int-hint" class="int-hint" style="display:none">💡 <span id="int-hint-text"></span></div>
              <div class="int-input-row">
                <input type="text" id="int-input" class="int-input" placeholder="Nhập câu trả lời..." autocomplete="off">
                <button type="button" id="int-send" class="int-send-btn" onclick="window.clSendAnswer()">
          ...
          <!-- Summary -->
          <div id="int-summary" style="display:none">
            <div class="int-summary-header">
              <div class="int-summary-ring">
                <svg viewBox="0 0 36 36" class="int-circular">
                  <path class="spr-circle-bg" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"/>
                  <path class="spr-circle-fill" id="int-summary-fill" stroke-dasharray="0,100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"/>
                  <text x="18" y="20.5" class="spr-circle-text" id="int-summary-score">-</text>
                </svg>
              </div>
              <div class="int-summary-text">
                <h3 id="int-summary-title">Kết thúc buổi phỏng vấn</h3>
                <p id="int-summary-feedback" style="color:#64748b;font-size:.85rem;"></p>
              </div>
            </div>
            ...
            <div class="int-summary-section" style="margin-bottom:1rem">
              <h4>💡 Lời khuyên</h4>
              <ol id="int-tips"></ol>
            </div>
            <div class="int-actions">
